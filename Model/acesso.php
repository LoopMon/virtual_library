<?php
    ...
    Class Acesso{
        ...
        public function __construct($conexao){
            ...
            $this->mail->Username = "virtual.library.suport@gmail.com";
            $this->mail->Password = "sUporT#$vL$#SuPort";
            $this->mail->SingleTo = true;

            $this->mail->From = "virtual.library.suport@gmail.com";
            $this->mail->FromName = "Virtual Library";
        }
